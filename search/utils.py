...
=======
	if  offset == 0 and raw_user_tags[offset+len(tag)]==u'<': # 说明使用了field搜索
>>>>>>> 8768ac45f67121d0ea9366fb7addbfa34af865cc
...
if __name__ == '__main__':
	...
	print '1.'
	print getFieldValueInCommand("title:哈哈 user_tags:人生^20.0 美丽^2.0",'user_tags')[0]
	print '2.'
	print getFieldValueInCommand("title:哈哈 user_tags:人生^20.0 ",'adjs')
	print '3.'
	print getAdjValueInRawAdjs('哈哈=23,呵呵=90,哈=30','哈')
	print '4.'
	print getTagValueInRawTags('哈哈<>23￥呵呵<>90￥哈<>90','哈')
